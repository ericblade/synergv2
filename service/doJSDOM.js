...
var html = fs.readFileSync('./jsdominput.txt');
var messages = JSON.parse(fs.readFileSync('./jsdommessages.txt'));
...
fs.writeFileSync('./jsdomoutput.txt', JSON.stringify(msgArray));
