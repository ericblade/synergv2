...
function getDefaultParser() {
  ...
  if (defaultParser === null) {
    try {
      defaultParser = require(modulePath+'/jsdom/node_modules/htmlparser/lib/htmlparser');
    }
    catch (e) {
      try {
        defaultParser = require(modulePath+'/jsdom/node_modules/htmlparser/pulls/node-htmlparser/lib/node-htmlparser');
      }
      catch (e2) {
